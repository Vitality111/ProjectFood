...
window.addEventListener("DOMContentLoaded", () => {
  ...
  const slide = document.querySelectorAll(".offer__slider-counter"),
    ...
    slodeWrap = document.querySelector(".offer__slider-wrapper");

  function hideSlideContent() {
    offer.forEach((item) => {
      item.style.display = "none";
    });
    slodeWrap.forEach((item) => {
      item.classList.remove('offer__slider-wrapper__active');
    });
  }
  hideSlideContent();
});
